...
public abstract class Popups : MonoBehaviour
{
    ...
    //static GameObject _canvasPopupAnimated;
    //public static GameObject CanvasPopupAnimated
    //{
    //    get
    //    {
    //        if (_canvasPopup == null)
    //            _canvasPopup = GameObject.FindWithTag("Canvas Popup Animated");
...
;
    ...
    public virtual void Disappear(Action onClose = null)
    {
        //Root.alpha = 0;
